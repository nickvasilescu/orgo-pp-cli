...
func newComputersScrollScrollCmd(flags *rootFlags) *cobra.Command {
	var bodyAmount int
	...
	cmd.Flags().IntVar(&bodyAmount, "amount", 3, "Scroll amount (clicks)")
	cmd.Flags().StringVar(&bodyDirection, "direction", "", "Scroll direction")
