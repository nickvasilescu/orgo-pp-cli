...
func newComputersBashExecuteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun {
				_ = logActionBestEffort(cmd.Context(), args[0], "bash", map[string]any{"command": bodyCommand}, string(data), statusCode, time.Since(start))
			}
	...
	cmd.Flags().StringVar(&bodyCommand, "command", "", "Bash command to execute")
