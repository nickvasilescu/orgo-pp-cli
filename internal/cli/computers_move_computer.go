...
func newComputersMoveComputerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyProjectId, "project-id", "", "Destination workspace ID")
